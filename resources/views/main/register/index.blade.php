            ...
            <div class="card shadow" style="width: 32rem">
                <div class="card-body shadow">
                    ...
                    @enderror"
                        ...
                        is-invalid
                    @enderror"
                            placeholder="youremail@example.com" name="email" id="email" autofocus>
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        is-invalid
                    @enderror"
                            placeholder="yourpassword" name="password" id="password">
                        @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="d-grid gap-2 my-3">
                            <button type="submit" class="btn btn-primary d-block"> Register <i
